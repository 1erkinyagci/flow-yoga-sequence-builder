...
FLOW is a comprehensive web application designed for yoga instructors to create, organize, and share professional yoga class sequences. The platform features an extensive pose library with 100+ yoga poses, each with detailed alignment cues, benefits, contraindications, and Sanskrit names.
...
- **Sequence Builder**: Drag-and-drop interface for creating professional yoga class sequences
- **Print & Export**: Generate printable sequence cards and PDF exports
...
- **Type**: Standing, Forward Fold, Backbend, Twist, Inversion, Balancing, Kneeling
- **Focus Area**: Hips, Hamstrings, Shoulders, Spine, Core, Legs, Chest, Full Body
